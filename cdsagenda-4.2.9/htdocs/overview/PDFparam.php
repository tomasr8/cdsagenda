<?php
// $Id: PDFparam.php,v 1.1.1.1.4.3 2002/10/23 08:56:38 tbaron Exp $

// PDFparam.php --- create a pdf
//
...
//
// PDFparam.php is part of CDS Agenda.
//
...
$Template->set_file(array("mainpage"  => "pdfparam.ihtml"));
?>
...
$Template->set_var("pdfparam_param", $paramText);
