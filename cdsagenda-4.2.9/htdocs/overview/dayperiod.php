<?php
// $Id: dayperiod.php,v 1.1.1.1.4.5 2003/03/28 10:15:59 tbaron Exp $
...
//
// dayperiod.php is part of CDS Agenda.
//
...
function dayperiod()
{
    ...
    $nextday = $selecteddate + 86400;
    $nday = date ('j',$nextday);
    $nmonth = date ('n',$nextday);
    $nyear = date ('Y',$nextday);
    $previousday = $selecteddate - 86400;
...
<TR>\n";
    ...
    $outStr .= "<BR><TABLE width=\"100%\"><TR><TD align=left width=\"50%\"><A HREF=\"\" onClick=\"javascript:SetDate($pday,$pmonth,$pyear);return false;\"><IMG SRC=\"../images/backward.gif\" ALT=\"previous day\" border=0></A></TD><TD align=right width=\"50%\"></font><A HREF=\"\" onClick=\"javascript:SetDate($nday,$nmonth,$nyear);return false;\"><IMG SRC=\"../images/forward.gif\" ALT=\"next day\" border=0></A></TD></TR></TABLE>\n";
