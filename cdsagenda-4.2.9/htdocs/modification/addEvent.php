<?php
// $Id: addEvent.php,v 1.1.1.1.4.4 2003/03/28 10:25:08 tbaron Exp $
// addEvent.php --- add a simple event
//
...
//
// addEvent.php is part of CDS Agenda.
//
...
// Template set-up
$Template->set_file(array( "mainpage" => "addEvent.ihtml", "error" => "error.ihtml" ));
...
$Template->set_var("addEv_FID","$fid");
$Template->set_var("addEv_LEVEL","$level");
$time=time();
...
$Template->set_var( "addEventRooms", $str_rooms );
    
// $baseLocationName from config.php
$Template->set_var( "addEvent_baselocation", $baseLocationName );
