...
<xsl:for-each select="minutes">
	...
	<tr>
		<td align="center">
		<img src="images/iconeye.gif" alt=""/><b> minutes of the meeting</b>
		</td>
	</tr>
	<tr>
		<td>
...
<tr>
	<td colspan="4">
	<br/><xsl:text disable-output-escaping="yes">&#38;nbsp;</xsl:text><br/><br/><xsl:text disable-output-escaping="yes">&#38;nbsp;</xsl:text><b>
...
<xsl:call-template name="sessionheader">
	...
	<xsl:for-each select="minutes">
		...
		<tr>
			<td align="center">
			<img src="images/iconeye.gif" alt=""/><b> minutes of the session</b>
			</td>
		</tr>
		<tr>
			<td>
...
&#60;tr bgcolor="#90C0F0" class="header"&#62;
	...
	<xsl:if test="@broadcasturl != ''">
		...
		<img src="images/camera.gif" border="0"/>
		<br/><font color="white">(video broadcast)</font></a>
	</xsl:if>
	</td>
	...
	<tr>
		...
		<xsl:if test="@category != '' and @category != ' '">
			<font size="+1" bgcolor="#000060" class="headerselected">
		...
		<xsl:if test="count(child::link) != 0">
			...
			<xsl:for-each select="link">
				<small>
				<img src="images/iconfwdi.gif" alt=""/>
				<a href="{@url}">
	...
	<tr>
		...
		<tr>
			<td align="center">
			<img src="images/iconeye.gif" alt=""/><b> minutes of the talk</b>
			</td>
		</tr>
		<tr>
			<td>
