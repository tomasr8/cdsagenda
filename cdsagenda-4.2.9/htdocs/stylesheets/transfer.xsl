...
&#60;tr bgcolor="#90C0F0" class="header"&#62;
	...
	<tr>
		...
		<font size="+1" color="green">
			[<xsl:value-of select="../../@id"/><xsl:value-of select="../@id"/><xsl:value-of select="@id"/>]
			<a href="http://doc.cern.ch/submit?RNSEM={$ida}{$ids}{$idt}@FTTSEM">
		Transfer file
                </a>
			- <a href="http://doc.cern.ch/submit?RNSEM={$ida}{$ids}{$idt}@MBISEM">
		Add Abstract
		</a>
